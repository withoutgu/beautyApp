...
//                        self.list = data
                        ...
                        for(var i = 0;i<len;i++){
                            ...
                            grid.html(`
                                <div class="shadeWrap">
                                    <img src="${self.list[i].url}"/>
                                    <div class="shade">
                                        <table>
                                            <tr>
                                                <td class="imgTitle">${self.list[i].title}</td>
                                                <td style="width: 20%;"><mu-icon-button icon="clear" color="#fff" class="deleteBtn" onclick="delImg(${self.list[i].title})"/></td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
                            `)
                            grid.appendTo($('#colWrap'));
                        }
                    }
                )
                callback();
